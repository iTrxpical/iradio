...
client.on('ready', () => {
    console.log(`Logged in as ${client.user.tag}! There are no apparent major bugs on iRadio.`);
    client.user.setActivity('music to iRadio | .help', { type: 'PLAYING' });
...
client.on('message', async function (message) {
    ...
    if (message.channel.type === 'dm') {
        message.channel.send("**We are unable to help with issues outside of the offical iRadio discord server. Please join here, https://discord.gg/KUbgYSC !** *Disclaimer: if you believe this is an error, please contact *`TheReal#1781`*!*")
        return;
    }
